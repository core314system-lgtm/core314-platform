  ...
  return `
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="border: 1px solid #e5e7eb; border-top: none; padding: 32px; border-radius: 0 0 12px 12px; background: #ffffff;">
        ...
        <p style="font-size: 14px; color: #374151; line-height: 1.7;">Questions? Reply to this email or reach us at <a href="mailto:support@core314.com" style="color: #1e40af;">support@core314.com</a>.</p>
