...
const DEFAULT_FIELDS: TemplateField[] = [
  ...
  { id: 'df-6', field_name: 'scope_inclusions', field_label: 'Scope Inclusions', field_type: 'textarea', is_required: false, help_text: '', placeholder: 'Describe what is included in your quote', options: null, display_order: 5, is_default_field: true, default_field_key: 'scope_inclusions' },
