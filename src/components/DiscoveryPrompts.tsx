...
import {
  ...
  Calendar, Users, ShieldAlert, Mic, Scale, BarChart3,
} from 'lucide-react'
...
const DISCOVERY_ITEMS: DiscoveryItem[] = [
  ...
  {
    id: 'proposal_outline',
    label: 'Proposal Outline Builder',
    description: 'AI generates a proposal volume structure mapped to RFP evaluation criteria — per project.',
    path: '/projects',
    icon: FileText,
    projectScoped: true,
  },
  {
    id: 'win_themes',
    label: 'Win Theme Generator',
    description: 'AI-generated discriminators and ghost themes based on competitive intel and past performance — per project.',
    path: '/projects',
    icon: Target,
    projectScoped: true,
  },
  {
    id: 'oci_screening',
    label: 'OCI Screening',
    description: 'FAR 9.5 conflict of interest questionnaire to assess OCI risk before pursuing opportunities — per project.',
    path: '/projects',
    icon: ShieldAlert,
    projectScoped: true,
  },
  {
    ...
    label: 'Proposal Schedule',
    description: 'Shipley-aligned milestone tracker from RFP release through submission and color team reviews — per project.',
    path: '/projects',
    icon: Calendar,
    projectScoped: true,
  },
  {
    id: 'teaming_evaluator',
    label: 'Teaming Partner Evaluator',
    description: 'AI scores your subcontractors as potential teaming partners based on NAICS, certs, and relevance — per project.',
    path: '/projects',
    icon: Users,
    projectScoped: true,
  },
  {
    id: 'cpars_tracker',
    label: 'CPARS Score Tracker',
    description: 'Track CPARS ratings across contracts with trend analysis for Quality, Schedule, Cost, and Management.',
    path: '/cpars-tracker',
    icon: Award,
  },
  {
    id: 'fiscal_calendar',
    label: 'Gov FY Calendar',
    description: 'Federal fiscal year spending cycles, budget milestones, and procurement timing.',
    path: '/government-fiscal-calendar',
    icon: Calendar,
  },
  {
    id: 'protest_risk',
    label: 'Protest Risk Assessment',
    description: 'AI analyzes protest likelihood based on competitive landscape and procurement methodology — per project.',
    path: '/projects',
    icon: Scale,
    projectScoped: true,
  },
  {
    id: 'oral_prep',
    label: 'Oral Presentation Prep',
    description: 'Team assignments, AI scenario questions, and dry-run checklist for oral proposals — per project.',
    path: '/projects',
    icon: Mic,
    projectScoped: true,
  },
  {
    id: 'source_selection',
    label: 'Source Selection Model',
    description: 'Model evaluation factor weights and compare your score against competitors — per project.',
    path: '/projects',
    icon: BarChart3,
    projectScoped: true,
  },
