...
const allProductLinks = [
  ...
  { label: 'Subcontractor Network', to: '/for-subcontractors' },
  { label: 'Integrations', to: '/integrations-overview' },
  { label: 'Pricing', to: '/pricing' },
]

const footerLinks = {
  product: PRICING_VISIBLE ? allProductLinks : allProductLinks.filter(l => l.to !== '/pricing'),
  solutions: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-xs text-slate-500">
            ...
            <Link to="/ai-disclaimer" className="hover:text-slate-300 transition-colors">AI Disclaimer</Link>
            <Link to="/ai-data-processing" className="hover:text-slate-300 transition-colors">AI Data Processing</Link>
          </div>
        </div>
