...
const faqs = [
  ...
  { q: 'What is the uptime target?', a: 'Procuvex targets 99.9% monthly uptime, backed by 24/7 automated health monitoring, retry logic with circuit breakers, and self-healing infrastructure. A contractually binding uptime SLA with service credits is available to Enterprise customers under a signed agreement. View real-time system status at any time on our Status page.' },
