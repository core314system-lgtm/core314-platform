...
const capabilities = [
  ...
  { icon: Users, title: 'Subcontractor Matching', desc: 'Database of 130,000+ subs sourced from public government records, with radius-based matching to your project site.' },
