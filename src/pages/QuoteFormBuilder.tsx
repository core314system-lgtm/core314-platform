...
const DEFAULT_FIELDS: FormField[] = [
  ...
  { id: 'df-7', field_name: 'scope_inclusions', field_label: 'Scope Inclusions', field_type: 'textarea', is_required: true, help_text: 'What is included in your quote', placeholder: '', options: null, display_order: 6, is_default_field: true, default_field_key: 'scope_inclusions' },
