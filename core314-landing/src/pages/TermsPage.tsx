      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 md:p-12 shadow-sm">
          ...
          <div className="prose prose-slate max-w-none space-y-6 text-slate-600" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>2. Use of Services</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>3. Intellectual Property</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>4. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>5. Modifications</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>6. Contact Information</h2>
              <p>
