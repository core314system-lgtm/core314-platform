      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 md:p-12 shadow-sm">
          ...
          <div className="prose prose-slate max-w-none space-y-6 text-slate-600" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>3. Data Security</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>4. Data Retention</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>5. Your Rights</h2>
              <p>
