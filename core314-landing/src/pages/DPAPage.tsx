      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="bg-gradient-to-br from-[#001a33] to-[#0A0F1A] border border-[#00BFFF]/30 rounded-2xl p-8 md:p-12">
          ...
          <div className="prose prose-invert prose-cyan max-w-none space-y-6 text-gray-300" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00BFFF] mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>1. Definitions</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00BFFF] mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>2. Scope and Applicability</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00BFFF] mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>3. Data Processing</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00BFFF] mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>4. Security Measures</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00BFFF] mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>5. Sub-Processors</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00BFFF] mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>6. Data Subject Rights</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00BFFF] mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>7. Data Breach Notification</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00BFFF] mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>8. Deletion and Return of Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00BFFF] mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>9. Audits</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#00BFFF] mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>10. Contact</h2>
              <p>
