...
export function SentryTest() {
  ...
  const testException = () => {
    try {
      ...
      throw new Error('Sentry test exception from core314-admin');
    } catch (error) {
  ...
  const testMessage = () => {
    ...
    Sentry.captureMessage('Sentry test message from core314-admin', 'info');
  ...
  const testBreadcrumb = () => {
    ...
    Sentry.addBreadcrumb({
      category: 'test',
      message: 'Test breadcrumb from core314-admin',
      level: 'info',
    });
  ...
  const testErrorBoundary = () => {
    ...
    throw new Error('Sentry ErrorBoundary test from core314-admin');
  };
    ...
    <div className="container mx-auto p-6 max-w-4xl">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Test Sentry error tracking and monitoring for core314-admin
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-md">
            ...
            <ol className="list-decimal list-inside space-y-1 text-sm">
              ...
              <li>Go to your Sentry dashboard for core314-admin project</li>
