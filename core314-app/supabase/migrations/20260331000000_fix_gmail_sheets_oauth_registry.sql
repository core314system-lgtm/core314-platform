...
-- Fix Gmail: add OAuth URLs and scopes (production-grade: readonly + send)
UPDATE integration_registry
SET
  oauth_authorize_url = 'https://accounts.google.com/o/oauth2/v2/auth',
  oauth_token_url = 'https://oauth2.googleapis.com/token',
  oauth_scopes = ARRAY['https://www.googleapis.com/auth/gmail.readonly', 'https://www.googleapis.com/auth/gmail.send']
