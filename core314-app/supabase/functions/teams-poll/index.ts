      ...
      try {
          ...
          if (refreshToken) {
            const tokenResponse = await fetch('https://login.microsoftonline.com/common/oauth2/v2.0/token', {
              ...
              body: new URLSearchParams({
                ...
                client_id: Deno.env.get('TEAMS_CLIENT_ID') || Deno.env.get('CORE314_TEAMS_CLIENT_ID') || '',
                client_secret: Deno.env.get('TEAMS_CLIENT_SECRET') || Deno.env.get('CORE314_TEAMS_CLIENT_SECRET') || '',
        ...
        await supabase.from('integration_events').insert({
          ...
          metadata: {
            ...
            entity_hints: [personHint({ name: displayName || undefined })].filter(Boolean),
          },
        });
