...
const tierFeatures: Record<string, SubscriptionFeatures> = {
  ...
  professional: {
    ...
    maxUsers: 25,
    maxIntegrations: 5,
    features: ['core_dashboard', 'ai_insights', 'alerts', 'custom_branding', 'basic_metrics', 'advanced_analytics', 'optimization_engine'],
  ...
  enterprise: {
    ...
    maxUsers: -1,
    maxIntegrations: -1,
    features: ['full_access', 'ai_orchestration', 'audit_trails', 'api_access', 'account_manager', 'core_dashboard', 'ai_insights', 'alerts', 'custom_branding', 'basic_metrics', 'advanced_analytics', 'optimization_engine'],
