  ...
  return (
    <Router>
      <Routes>
        ...
        >
          {/* Default redirect - goes to dashboard immediately */}
          ...
          {/* Core routes: USER-FIRST access model */}
          {/* All authenticated users can access these immediately - NO org requirement */}
